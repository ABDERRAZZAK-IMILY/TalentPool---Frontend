            ...
            <div className={`bg-blue-800 text-white ${isSidebarOpen ? 'w-64' : 'w-20'} transition-all duration-300 ease-in-out`}>
                ...
                <nav className="mt-8">
                    <ul className="space-y-2 px-4">
                        ...
                        <li>
                            <Link to="/admin/recruiters" className="flex items-center p-2 rounded-lg hover:bg-blue-700 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
                                {isSidebarOpen && <span className="ml-3">Recruteurs</span>}
                            </Link>
                        </li>
                        <li>
                            <Link to="/admin/annonces" className="flex items-center p-2 rounded-lg hover:bg-blue-700 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li>
                            <Link to="/admin/users" className="flex items-center p-2 rounded-lg hover:bg-blue-700 transition-colors">
                                ...
                                {isSidebarOpen && <span className="ml-3">Gestion Utilisateurs</span>}
                            </Link>
                        </li>
                    </ul>
                </nav>
